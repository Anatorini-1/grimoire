...
private val LightColorScheme = lightColorScheme(
    primary = Color(0xff0232ee),
    primaryContainer = Color(0xFF8473f8),
    onPrimary = Color.White,
    onPrimaryContainer = Color.Black,
    secondary = Color(0xFFeebf08),
    secondaryContainer = Color(0xFFf9e8ad),
    onSecondary = Color.Black,
    onSecondaryContainer = Color.Black,
    tertiary = Color(0xFFbf02ee),
    tertiaryContainer = Color(0xFFe9b9f8),
